        ...
        <div class="frm_user_moderation">
            <div>
                <label class="frm_left_label" <?php FrmRegAppHelper::maybe_add_tooltip('mod_email'); ?>>
                    <input type="checkbox" name="options[reg_moderate][]" value="email" <?php FrmRegAppController::array_checked($values['reg_moderate'], 'email'); ?> /> <?php _e('Email confirmation', 'frmreg') ?>
                </label>
            ...
            <div style="display:none;">
                <label <?php FrmRegAppHelper::maybe_add_tooltip('mod_paypal'); ?>>
                    <input type="checkbox" name="options[reg_moderate][]" value="paypal" <?php FrmRegAppController::array_checked($values['reg_moderate'], 'paypal'); ?> /> <?php _e('Complete Paypal payment', 'frmreg') ?>
                </label>
            </div>
            <?php }//end if ?>
        </div>

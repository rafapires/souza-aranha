    ...
    <table class="form-table">
        ...
        <table class="form-table" id="frm_usermeta_rows">
            <?php foreach ( $form_action->post_content['reg_usermeta'] as $meta_key => $usermeta_vars ) {
                ...
                $echo = true;
                $action_control = $this;
                include(FrmRegAppController::path() .'/views/new_usermeta_row.php');
        ...
        <table class="form-table">
            <tr><td width="250px">
                <label <?php FrmRegAppHelper::maybe_add_tooltip('mod_email'); ?>>
                    <input type="checkbox" name="<?php echo $this->get_field_name('reg_moderate') ?>[]" value="email" <?php FrmRegAppController::array_checked($form_action->post_content['reg_moderate'], 'email'); ?> /> <?php _e('Email confirmation', 'frmreg') ?>
                </label>
            </td>
            ...
            <tr class="frm_hidden">
                ...
                <label <?php FrmRegAppHelper::maybe_add_tooltip('mod_admin'); ?>>
                    <input type="checkbox" name="<?php echo $this->get_field_name('reg_moderate') ?>[]" value="admin" <?php FrmRegAppController::array_checked($form_action->post_content['reg_moderate'], 'admin'); ?> /> <?php _e('Admin approval', 'frmreg') ?>
                </label>
                </td>
            </tr>
            ...
            <tr class="frm_hidden">
                ...
                <label <?php FrmRegAppHelper::maybe_add_tooltip('mod_paypal'); ?>>
                    <input type="checkbox" name="<?php echo $this->get_field_name('reg_moderate') ?>[]" value="paypal" <?php FrmRegAppController::array_checked($form_action->post_content['reg_moderate'], 'paypal'); ?> /> <?php _e('Complete Paypal payment', 'frmreg') ?>
                </label>
                </td>
            </tr>
            <?php }//end if ?>
